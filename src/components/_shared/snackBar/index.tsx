...
import { Toast } from "../../../context/snackbar";
type SnackBarProps = {
    toast: Toast;
    onClose: () => void;
};
...
export const SnackBar: Component<SnackBarProps> = (props) => {
    ...
    const [duration, setDuration] = createSignal(toast.duration);
    ...
    return (
        <div class="flex flex-row items-center w-full max-w-lg p-4 text-gray-500 bg-white rounded-lg shadow ">
            <Switch>
